...
class PatientModel(Base):
    ...
    __table_args__ = (CheckConstraint('version > 0', name='ck_patients_positive_version'),)
...
class ProcedureModel(Base):
    ...
    __table_args__ = (CheckConstraint('version > 0', name='ck_procedures_positive_version'),)
    version: Mapped[int] = mapped_column(BigInteger, server_default='1', nullable=False)
...
class SpecialtyModel(Base):
    ...
    __table_args__ = (CheckConstraint('version > 0', name='ck_specialties_positive_version'),)
    version: Mapped[int] = mapped_column(BigInteger, server_default='1', nullable=False)
