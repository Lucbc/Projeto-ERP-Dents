...
**2B.5.2.1 implementada, aguardando CI:** [pagamentos, estornos e recibos duráveis](./homologacao-etapa-2B5-2-1.md). Homologação atualizada em `0020_financial_history`, API/frontend juntos. Regressão local de 187 casos aprovada; 11 testes finais de histórico (incluindo um novo) e 60 frontend aprovados. Banco/API/Chrome e preservação verificados; falta publicação/CI antes de concluir. A etapa 2B e referências históricas de R26 continuam parcialmente pendentes.
