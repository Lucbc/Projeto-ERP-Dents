...
- **CI final aprovado:** implementação `9e85823`, proxies `5ff12bd` e ajuste de testes `ed0132b` publicados no `origin/main`. [GitHub Actions 35487864107](https://github.com/Lucbc/Projeto-ERP-Dents/actions/runs/35487864107) aprovado em 10min12s, com 147 backend, 46 frontend, HTTP, builds e auditorias. Gateway confirmou 413/503, dois JSON 408 em 30,011s, vagas liberadas e 80 chamadas de saúde, p95 de 0,0379s. **Etapa 2B.3 concluída em 20/09/2026.** Fechamento posterior somente documental.

### Correções encontradas no CI e validadas em 20/09/2026

No [CI 35467879087](https://github.com/Lucbc/Projeto-ERP-Dents/actions/runs/35467879087), o smoke de upload incompleto recebeu `RemoteDisconnected`, sem resposta HTTP. A falha foi reproduzida localmente com a configuração original: API, gateway e HTTPS tinham prazos de 30 segundos. O fechamento pelo proxy pode anteceder o JSON 408 da API; o [registro oficial do Nginx](https://trac.nginx.org/nginx/ticket/1005) descreve o encerramento sem resposta no próprio timeout. O log remoto não identifica qual dos dois proxies venceu a disputa.
